...
export function Reply({ replyFormActive }: { replyFormActive: boolean }) {
    return (
        <svg
...
export function ImagePlaceholderIcon({ size }: { size: number }) {
    ...
    return (
        <svg
            ...
            strokeWidth="2"
            stroke="currentColor"
            className={`w-${size} h-${size} text-slate-500`}
        >
            <path
                strokeLinecap="round"
                strokeLinejoin="round"
